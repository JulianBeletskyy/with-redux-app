                    ...
                    <div className="container">
                        <div className="bg-white p-15">
                            ...
                            <div className="form-group">
                                <Row>
                                    <Col sm={8} xsHidden>
                                        We want to see you! Our initial attraction to an individual, is almost exclusively based on appearance. It’s human nature. Within the first seconds of seeing someone, we decide if the person seems friendly, interesting, kind or fun. That’s why it’s imperative that you upload a profile picture. Statistics show that profiles without a photo have a lower chance of being viewed. To increase the likelihood of being selected, upload a recent (within the last 2 years), clear, photo of yourself. You must be the only person in the shot. Make sure the background is not distracting. Smile.<br />
